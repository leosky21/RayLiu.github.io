...
<body>
	...
	<div class="rt_content">
		...
		<section>
		<form style="text-align: center;" action="${pageContext.request.contextPath }/AddUserServlet" method="post">
			<ul class="ulColumn2">
				<li><span class="item_name" style="width:120px;">账号：</span> <input
				  name="username"	type="text" class="textbox textbox_295" placeholder="账号" /> <!--<span class="errorTips" >错误提示信息...</span>-->
				</li>
				<li><span class="item_name" style="width:120px;">公司名：</span> <input
					name="company" type="text" class="textbox textbox_295" placeholder="公司名" /> <!--<span class="errorTips">错误提示信息...</span>-->
				</li>
				<li><span class="item_name" style="width:120px;">联系方式：</span> <input
					 name="tel" type="text" class="textbox textbox_295" placeholder="联系方式" /> <!--<span class="errorTips">错误提示信息...</span>-->
				</li>
				<li><span class="item_name" style="width:120px;">密码：</span>
				 <input
					name="password" type="text" class="textbox textbox_295" placeholder="密码" /> <!--<span class="errorTips">错误提示信息...</span>-->
				</li>
