    ...
    ajax(
        {
            ...
            callback: function (datas) {
                ...
                ajax(
                    {
                        method: 'POST',
                        url: 'bookManageAction_getBook.action',
                        params: "bookId=" + id,
                        type: "json",
                        callback: function (data) {
                        	...
                        	for(var index in datas) {
        						var str="";
        						var bookTypeId = data.fk_booktype;
        						if(bookTypeId == datas[index].id){
        							str+="<option selected=selected value='"+datas[index].id+"'>"+ datas[index].name +"</option>";
        							
        						}else{
        					
        							str+="<option value='"+datas[index].id+"'>"+ datas[index].name +"</option>";
        						}
        						$("#updateBookType").append(str);
        						$("#updateBookType").change();
        					}
                        }
