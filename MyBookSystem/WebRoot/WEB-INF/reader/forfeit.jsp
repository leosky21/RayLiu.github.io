                    ...
                    <div class="panel panel-default bootstrap-admin-no-table-panel">
                        ...
                        <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                            <form class="form-horizontal"
                                  action="${pageContext.request.contextPath}/reader/forfeitAction_queryForfeitInfo.action"
                                  method="post">
                                <div class="row">
                ...
                <div class="col-lg-12">
                    <table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
                        ...
                        <c:if test="${requestScope.pb.beanList!=null}">
                            <c:forEach items="${requestScopepb.beanList}" var="forfeit">
                                <tbody>
                                ...
                                <td>
                                    <button type="button" class="btn btn-info btn-xs" data-toggle="modal"
                                            ...
                                            onclick="getForfeitInfoById(<s:property value="${forfeit.borrowId}"/>)">查看
                                    </button>
                        ...
                        <div class="pull-right"><!--右对齐--->
                            <ul class="pagination">
                                <li class="disabled"><a href="#">第<s:property
                                        value="${requestScopepb.pageCode}"/>页/共<s:property
                                        value="${requestScopepb.totaPage}"/>页</a>
                                </li>
                                <li>
                                    <a href="${pageContext.request.contextPath}/reader/forfeitAction_${pb.url }pageCode=1">首页</a>
                                </li>
                                <li>
                                    <a href="${pageContext.request.contextPath}/reader/forfeitAction_${pb.url }pageCode=${pb.pageCode-1 }">&laquo;</a>
                                </li><!-- 上一页 -->
                                    <%-- 循环显示页码列表 --%>
                                <c:forEach begin="${begin }" end="${end }" var="i">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <li>
                                                <a href="${pageContext.request.contextPath}/reader/forfeitAction_${pb.url }pageCode=${i}">${i}</a>
                                            </li>
                                        </c:otherwise>
                                    </c:choose>
                                </c:forEach>
                                ...
                                <c:if test="${pb.pageCode < pb.totaPage }">
                                    <li>
                                        <a href="${pageContext.request.contextPath}/reader/forfeitAction_${pb.url }pageCode=${pb.pageCode+1}">&raquo;</a>
                                    </li>
                                </c:if>
                                    <%--否则显示尾页 --%>
                                <li>
                                    <a href="${pageContext.request.contextPath}/reader/forfeitAction_${pb.url }pageCode=${pb.totaPage}">尾页</a>
                                </li>
                            </ul>
                        </div>
                    </s:if>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control" id="name" placeholder="请输入您的真实姓名"
                                   value='<s:property value="${sessionScope.reader.name}"/>'>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control" id="phone" placeholder="请输入您的联系号码"
                                   value='<s:property value="${sessionScope.reader.phone}"/>'>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control" id="email" placeholder="请输入您的邮箱"
                                   value='<s:property value="${sessionScope.reader.email}"/>'>
