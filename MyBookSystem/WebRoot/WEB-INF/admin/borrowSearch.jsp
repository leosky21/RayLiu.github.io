...
<head>
    ...
    <script src="${pageContext.request.contextPath}/js/renewBook.js"></script>
</head>
                    ...
                    <div class="panel panel-default bootstrap-admin-no-table-panel">
                        ...
                        <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                            <form class="form-horizontal"
                                  action="${pageContext.request.contextPath}/admin/borrowSearchAction_list.action"
                                  method="post">
                                <div class="row">
                ...
                <div class="col-lg-12">
                    <table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
                        ...
                        <c:choose>
                            <c:when test="${pb.beanList != null }">
                                <!---在此插入信息-->
                                <c:forEach items="${pb.beanList }" var="back">
                    ...
                    <script type="text/javascript">
                        function page(pageCode) {
                            window.location.href = "${pageContext.request.contextPath}/admin/borrowSearchAction_list.action?pageCode=" + pageCode;
                        }
                    </script>
