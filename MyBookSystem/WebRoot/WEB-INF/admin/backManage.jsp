                    ...
                    <div class="panel panel-default bootstrap-admin-no-table-panel">
                        ...
                        <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                            <form class="form-horizontal"
                                  action="${pageContext.request.contextPath}/admin/backManageAction_list.action"
                                  method="post">
                                <div class="row">
                ...
                <div class="col-lg-12">
                                ...
                                <c:forEach items="${pb.beanList }" var="back">
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-success btn-xs"
                                                onclick="backBook(${back.borrowId})">归还
                                        </button>
                                    </td>
                                    </tbody>
                                </c:forEach>
                    ...
                    <script type="text/javascript">
                        function page(pageCode) {
                            window.location.href = "${pageContext.request.contextPath}/admin/backManageAction_list.action?pageCode=" + pageCode;
                        }
                    </script>
