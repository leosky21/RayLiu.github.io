                    ...
                    <div class="panel panel-default bootstrap-admin-no-table-panel">
                        ...
                        <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                            <form class="form-horizontal"
                                  action="${pageContext.request.contextPath}/admin/forfeitManageAction_list.action"
                                  method="post">
                                <div class="row">
                                    ...
                                    <div class="col-lg-5 form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" name="paperNO" type="text" value=""
                ...
                <div class="col-lg-12">
                        ...
                        <c:choose>
                            <c:when test="${pb.beanList != null }">
                                <c:forEach items="${pb.beanList }" var="forfeit">
                                    ...
                                    <td>${forfeit.ISBN}</td>
                                    <td>${forfeit.bookName}</td>
                                    <td>${forfeit.paperNO}</td>
                                    <td>${forfeit.readerName}</td>
                                    <td>${forfeit.overDay}</td>
                                    <td>${forfeit.fine}</td>
                                    <td>
                                        <button type="button" class="btn btn-info btn-xs" data-toggle="modal"
                                                data-target="#findBackModal"
                                                onclick="getForfeitInfoById(${forfeit.borrowId})">查看
                                        </button>
                                        <button type="button" class="btn btn-success btn-xs"
                                                onclick="pay(${forfeit.borrowId}">付款
                                        </button>
                                    </td>
                                    </tbody>
                                </c:forEach>
                    ...
                    <script type="text/javascript">
                        function page(pageCode) {
                            window.location.href = "${pageContext.request.contextPath}/admin/forfeitManageAction_list.action?pageCode=" + pageCode;
                        }
                    </script>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">缴纳状态</label>
                        <div class="col-sm-7">
