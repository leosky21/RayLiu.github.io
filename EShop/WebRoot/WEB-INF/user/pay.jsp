			...
			<div class="header_container">
				...
				<div class="top_bar clear">
					...
					<ul class="top_links fr">
						...
						<li class="highlight"><a href="#">支付页面</a></li>
						<li><a
		...
		<div class="section_container">
			<div class="pay-skip">
				...
				<div class="payskip-inner">
					...
					<div>
						<span>支付方式：</span><img class="zffs"
							src="${pageContext.request.contextPath }/files/yibao.jpg" alt="" />
					</div>
					<div>
						<span>支付银行：</span><img class="zfyh"
							src="${pageContext.request.contextPath }/files/bankImages/${pd_FrpId}.gif"
							alt="" />
					</div>
					<div>
						<form name="yeepay"
