...
<div class="login_div">
	...
	<form action="${pageContext.request.contextPath }/user/admin/login.action" class="login" method="post">
		<div class="nav">
			...
			<div class="nav login_psdNav">
				...
				<div class="col-xs-6">
					<input type="password" name="pass" id="psd" value="" placeholder="&nbsp;&nbsp;密码" onBlur="javascript:ok_or_errorBylogin(this)" />
				</div>
				<div class="col-xs-1 ok_gou">
					√
				</div>
...
<div class="register_body">
	...
	<form action="${pageContext.request.contextPath}/user/admin/register.action" class="register" method="post">
		<div class="nav">
			<div class="nav register_nav">
				...
				<div class="col-xs-6">
					<input type="text" name="name" id="name_r" value="" placeholder="&nbsp;&nbsp;用户名/手机号" onBlur="javascript:ok_or_errorByRegister(this)" />
				</div>
				<div class="col-xs-1 ok_gou">
					√
				</div>
			...
			<div class="nav register_psdnav">
				...
				<div class="col-xs-6">
					<input type="password" name="pass" id="psd_r" value="" placeholder="&nbsp;&nbsp;密码" onBlur="javascript:ok_or_errorByRegister(this)" />
				</div>
				<div class="col-xs-1 ok_gou">
					√
				</div>
			...
			<div class="nav register_affirm">
				...
				<div class="col-xs-6">
					<input type="password" name="pass" id="affirm_psd" value="" placeholder="&nbsp;&nbsp;确认密码" onBlur="javascript:ok_or_errorByRegister(this)" />
				</div>
				<div class="col-xs-1 ok_gou">
					√
				</div>
	...
	<div class="col-xs-12 barter_register">
		<button class="barter_registerBtn" onClick="javascript:barter_btn(this)" style="">已有权限?返回登录</button>
	</div>
</div>
<div style="text-align:center;" class="col-xs-12 barter_register">
	<p><a href="#">欢迎来到: e+后台管理系统</a></p>
</div>
</body>
</html>