...
<body style="width:100%; height:100%;">
	<div class="main">
  		 <ul class="nav nav-pills">
			...
			<li class="active"><a href="classInfoShow.jsp" >班级信息</a><span></span></li>
								...
								<div class="jumbotron col-lg-12 page-hearder" >
									<table class="table table-bordered table-hover">
										<caption>班级信息表</caption>
									   		...
									   		<c:forEach var="ci" items="${classes}" varStatus="ct">
									   			<tr>
									   				<td>${ct.count}</td><td>${ci.className }</td>
									   				<td>${ci.classRoom}</td><td>${ci.cTeacher }</td>
									   				<td>${ci.cNum }</td>
									   			</tr>
									   		</c:forEach>
									  </table>
