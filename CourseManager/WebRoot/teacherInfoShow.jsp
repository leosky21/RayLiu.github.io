	...
	<body style="width:100%; height:100%;">
				<div class="main">
			  		 <ul class="nav nav-pills">
						<li class="active"><a href="teacherInfoShow.jsp">教师信息</a><span></span></li>
								...
								<div class="jumbotron col-lg-12 page-hearder" >
									<table class="table table-bordered table-hover">
										<caption>教师信息表</caption>
									   		...
									   		<c:forEach var="ci" items="${teachers}" varStatus="ct">
									   			<tr>
									   				<td>${ct.count}</td><td>${ci.tId }</td>
									   				<td>${ci.tName}</td><td>${ci.tCourseName}</td>
									   				<td>${ci.tTel}</td><td>${ci.tMana}</td>
									   			</tr>
									   		</c:forEach>
									  </table>
									</div>
