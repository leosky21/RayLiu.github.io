...
<html>
  ...
  <div class="main">
	  	<ul class="nav nav-pills">
			...
			<li class="active"><a href="test/course.jsp">课程信息</a><span></span></li>
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<div class="jumbotron col-lg-8 col-lg-offset-2 page-hearder" >
							<form id="ff" name="rr" class="bs-example bs-example-form" role="form" action="mycourse!doManaCourse.action" method="post">
						        <div class="input-group">
						            <select name="select" >
										<option value="add">添加课程</option>
						        ...
						        <br>
						        <div class="input-group">
						            <span class="input-group-addon">需要周数:</span>
						            <input type="text" name="courseTime" id="courseTime" class="form-control">
						        </div>
						        <br>
						        <div class="input-group">
						            <span class="input-group-addon">是否为副科:</span>
						            <select name="courseIS" >
										<option value="true">主科</option>
										<option value="false">副科</option>
									</select>
						        </div>
						        <br>
