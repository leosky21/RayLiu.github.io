...
<html>
  <head>
    <base href="<%=basePath%>">
    <title>classcourse manager</title>
  ...
  <body>
  	<div class="main">
	  	<ul class="nav nav-pills">
			...
			<li class="active"><a href="test/classcourse.jsp">班级课程信息</a><span></span></li>
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<div class="jumbotron col-lg-8 col-lg-offset-2 page-hearder" >
							<form id="ff" name="rr" class="bs-example bs-example-form" role="form" action="myclasscourse!doManaClassCourse.action" method="post">
						        <div class="input-group">
						            <select name="select" >
										<option value="add">添加班级课程</option>
