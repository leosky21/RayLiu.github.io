...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath }/js/jscharts.js"></script>
    <script type="text/javascript">
        $(function(){
            $("#submit").click(function(){
                var colorArr = ['#44A622','#A7B629','#CAD857','#E4DB7B','#ECDE49','#ECC049','#EC9649','#D97431','#D95531','#E4DB7B'];
                $.post($("#medicine").val(), {number:$("#number").val()}, function(data){
