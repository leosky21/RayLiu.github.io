...
<head>
   ...
   <!-- http://www.jscharts.com/interface/template/id.81  jsChart -->
    <script type="text/javascript" src="${Med }/js/jquery-1.11.1.js"></script>
    <script type="text/javascript" src="${Med }/js/jscharts.js"></script>
    <script type="text/javascript">
        $(function(){
            $("#submit").click(function(){
                var colorArr = ['#44A622','#A7B629','#CAD857','#E4DB7B','#ECDE49','#ECC049','#EC9649','#D97431','#D95531','#E4DB7B'];
                //发送Ajax请求
                $.post($("#region").val(), {number:$("#number").val()}, function(data){
                    ...
                    myChart.setTitle('地域分析报表');
                    myChart.setTitleFontSize(10);
                    myChart.setTitleColor('#607985');
                    myChart.setAxisValuesColor('#607985');
                    myChart.setAxisNameX('地域名称', false);
                    myChart.setAxisNameY('用户量', true);
